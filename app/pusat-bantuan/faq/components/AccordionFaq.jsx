...
export default function AccordionFaq({
    ...
    return (
        ...
        <h2>
            <button
            className="flex items-center justify-between w-full text-left font-semibold py-2 bg-white rounded-lg p-6"
        ...
        <div
            ...
            className={`grid bg-white rounded-lg text-sm text-black overflow-hidden transition-all duration-300 ease-in-out ${accordionOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}
        >
