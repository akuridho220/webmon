...
export default function Faq() {
  ...
  return (
    <>
      <Layout>
        <div className="flex flex-col md:w-3/4 w-[90%] rounded-xl bg-primary-900/95 mt-10 p-6">
        ...
        <div className="flex flex-col w-[90%] md:w-3/4 rounded-xl bg-primary-900/95 mt-10 p-6">
          <div className="flex flex-col text-white items-center">
            ...
            <div className="mt-5 text-black md:text-base text-sm font-base">
              {faqs.map((faq, index) => (
                <AccordionFaq key={index} title={faq.title} id={`faqs-${index}`} active={faq.active}>
                  {faq.text}
                </AccordionFaq>
              ))}
            </div>
