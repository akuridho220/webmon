...
const ProgressBar = ({ detail, done, max }) => {
  ...
  return (
    <div className="pt-1">
      ...
      <div className="flex h-2 mb-4 overflow-hidden bg-red-100 rounded-md">
        <div style={{ width: `${progress}%`, transition: 'width 0.5s ease-in-out' }} className={`shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center ${color2} rounded-md`}></div>
      </div>
    </div>
  );
};
