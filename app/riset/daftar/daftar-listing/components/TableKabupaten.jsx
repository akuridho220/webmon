  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({row}) => {
        ...
        return (
          <Link href={`/riset/daftar/daftar-listing/detail-listing/kab/${data.kode_kab_full}`} className="flex items-center p-2 bg-accent-900 hover:bg-orange-700 text-white justify-center rounded-md">
