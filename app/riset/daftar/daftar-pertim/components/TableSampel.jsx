...
const TableTim = ({ data }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: 'Aksi',
      cell: ({ cell }) => (
        <button onClick={() => handleDetailButtonClick(cell.row.original)} className="bg-accent-900 text-white rounded-xl py-2 px-4 hover:bg-accent-700 transition duration-300">
          Detail
        </button>
      ),
    },
