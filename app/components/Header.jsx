...
export default function Header() {
  ...
  return (
    <>
      {/* Header Dekstop */}
      <header className="w-full items-center bg-putih-200/95 h-20 md:flex fixed top-0 right-0 justify-between z-10 shadow-md hidden">
        <div className="flex flex-row w-2/3 ml-8 justify-start">
          <Link href={'/dashboard'} className="flex flex-row items-center h-auto w-full px-4">
            ...
            <div className="py-2 text-primary-600 md:max-lg:text-xs text-sm">
              <p className="lg:text-lg font-bold">Web Monitoring</p>
              <p className="">PKL 63</p>
            </div>
          </Link>
          <div className="flex justify-center items-center w-full text-primary-600 md:max-lg:text-xs text-base">
            <Navbar />
          </div>
        </div>
        <div className="profile flex w-max px-4 md:max-lg:text-xs text-base">
      ...
      {/* Header Mobile */}
      <header className="w-full items-center bg-putih-200/95 h-16 flex fixed top-0 right-0 justify-between z-10 md:hidden">
